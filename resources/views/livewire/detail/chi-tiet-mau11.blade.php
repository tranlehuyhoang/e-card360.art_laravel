        ...
        <body
            ...
            <body>
                ...
                <section id="banner" class="section-banner">
                    <img src="{{ Storage::url($invitation->banner1) }}" alt="" class="banner-bg banner_top" style="object-position:center center">
                    <div class="banner-container container" style="background-color:#a7011182">
                        ...
                        <img src="/assets_1/wp-content/themes/wedding-studio/assets/china/img/hy-icon.png" alt="" class="banner-icon">
                        ...
                        <div class="banner-date text-gradient">
                            ...
                            <p class="name_palace banner_location_name">{{ $invitation->venue_name }}</p>
                ...
                <section id="about" class="section-about">
                    <div class="section-heading">
                        ...
                        <img src="/assets_1/wp-content/themes/wedding-studio/assets/china/img/hy-icon.png" alt="" class="icon">
                    </div>
                ...
                <section id="time-line" class="time-line-section img_bg bg_overlay" style="background-image:url({{ Storage::url($invitation->banner2) }})">
                    <div class="time-line container">
                        ...
                        <div class="timeline-list">
                            ...
                            <div class="timeline-item" data-aos="fade-up" data-aos-duration="1000">
                                <div class="timeline-media">
                                    <img src="{{ Storage::url($invitation->engagement_image) }}" alt="" class="timline-img">
                                </div>
                                <div class="timeline-body">
                                    <span class="story-date">{{ \Carbon\Carbon::parse($invitation->engagement_date)->format('d - m - Y') }}</span>
                                    <span class="title">Lễ đính hôn</span>
                                    <p class="timeline-des uk-margin-remove">Chúng ta từ 2 con người xa lạ mà bước vào cuộc đời nhau. Và giờ đây chúng ta tiếp tục cùng nhau sang trang mới.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-item" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div class="timeline-body">
                                    <span class="story-date">{{ \Carbon\Carbon::parse($invitation->wedding_date)->format('d - m - Y') }}</span>
                                    <span class="title">Lễ Thành Hôn</span>
                                    <p class="timeline-des uk-margin-remove">Em và anh không chỉ là người yêu mà chúng ta còn là tri kỷ. Ngày hôm nay, em sẽ là cô dâu của anh.</p>
                                </div>
                            </div>
    ...
    padding: 20px;
                ...
                <div class="uk-container">
                    ...
                    <div class="uk-grid-small uk-child-width-1-4 uk-flex-center uk-margin-large-top" uk-grid
                        uk-countdown="date: {{ \Carbon\Carbon::parse($invitation->event_date)->format('Y-m-d H:i:s') }}">
                        <div>
                            <div
                ...
                <section id="invitation" class="section-invitation">
                    <div class="container">
                        <div class="section-heading">
                            ...
                            <img src="{{ Storage::url($invitation->icon) }}" alt="" class="icon">
                        </div>
                            ...
                            <div class="invitation-container">
                                ...
                                <div class="invitation-card">
                                    ...
                                    <div class="social-link">
                                        ...
                                        <a href="{{ Storage::url($invitation->bride_family_image) }}" class="phone_number" data-fancybox>
                                ...
                                <div class="invitation-card">
                                    ...
                                    <div class="social-link">
                                        ...
                                        <a href="{{ Storage::url($invitation->groom_family_image) }}" class="phone_number" data-fancybox>
                                            <i class="ri-image-circle-fill"></i>
                                        </a>
