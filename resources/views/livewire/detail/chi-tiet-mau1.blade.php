                                            ...
                                            <div class="invi_time">
                                                ...
                                                <div class="invi_group_time">
                                                    <span class="invi_date_text">{{
                                                        $brideFamilyTime->translatedFormat('l') }}</span>

                                                    <span class="invi_year_text">{{ $brideFamilyTime->format('d') }}/ {{
                                                        $brideFamilyTime->translatedFormat('m') }}/ {{
                                                        $brideFamilyTime->format('Y') }}</span>
                                                </div>
                                    ...
                                    <div class="invitation-card">
                                        ...
                                        <div class="invitation-body">
                                            ...
                                            <div class="invi_time">
                                                ...
                                                <div class="invi_group_time">
                                                    <span class="invi_date_text">{{
                                                        $groomFamilyTime->translatedFormat('l') }}</span>

                                                    <span class="invi_year_text">{{ $groomFamilyTime->format('d') }}/ {{
                                                        $groomFamilyTime->translatedFormat('m') }}/ {{
                                                        $groomFamilyTime->format('Y') }}</span>
                                                </div>
